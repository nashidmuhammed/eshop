...
const PrivacyPolicy = () => {
  return (
    <div className='container text-justify mt-5'>
      <h1 className='text-xl font-bold'>Refund and Cancellation policy</h1>
        ...
        NFour does not accept cancellation requests for perishable items like flowers, eatables, etc.
        ...
        determined the same at its own end. This should be reported within 5 days
        of receipt of products.
        In case you feel that the product received is not as shown on the site or as per your expectations,
        you must bring it to the notice of our customer service within 5 days
        ...
        In case of any refunds approved by NFour 7 days
        , it will take for the refund to be processed to
        you
      </div>
  );
};
